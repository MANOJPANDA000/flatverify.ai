  ...
  static List<BhkPreset> getPresets() {
    return [
      BhkPreset(
        ...
        shortLabel: '2 BHK',
        description:
            'Living, 2 Bedrooms, Kitchen, Utility (Inside), Balcony, 2 Toilets',
        rooms: [
          ReraRoomData(
            id: 'r1',
            name: 'Living / Dining',
          ...
          ReraRoomData(
            ...
            length: 6.0,
            width: 4.5,
            spaceType: RoomSpaceType.utilityInside,
          ),
          ReraRoomData(
            id: 'r6',
            name: 'Living Balcony',
            length: 12.0,
            width: 4.5,
            spaceType: RoomSpaceType.balcony,
          ),
          ReraRoomData(
            id: 'r7',
            name: 'Master Toilet',
      ...
      BhkPreset(
        ...
        shortLabel: '3 BHK',
        description:
            'Living, 3 Bedrooms, Kitchen, Dry Balcony, 2 Balconies, 3 Toilets',
        rooms: [
          ReraRoomData(
            id: 'r10',
            name: 'Living Room',
          ...
          ReraRoomData(
            id: 'r16',
            name: 'Dry Balcony (Wash Yard)',
            length: 7.0,
            width: 5.0,
            spaceType: RoomSpaceType.utilityOutside,
          ),
          ReraRoomData(
            id: 'r17',
            name: 'Deck Balcony',
      ...
      BhkPreset(
        ...
        shortLabel: '1 BHK',
        description:
            'Living, 1 Bedroom, Kitchen with Enclosed Utility, Balcony, Toilet',
        rooms: [
          ReraRoomData(
            id: 'r30',
            name: 'Living / Dining',
      ...
      BhkPreset(
        ...
        shortLabel: '4 BHK',
        description:
            'Double Living, 4 Bedrooms, Wet/Dry Kitchen, Terrace, 4 Toilets',
        rooms: [
          ReraRoomData(
            id: 'r40',
            name: 'Formal Living',
