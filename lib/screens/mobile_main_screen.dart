...
class _MobileMainScreenState extends State<MobileMainScreen> {
  ...
  ReraAreaDisplayUnit _displayUnit = ReraAreaDisplayUnit.sqFt;
        ...
        actions: [
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () {
                setState(() {
                  _displayUnit = _displayUnit == ReraAreaDisplayUnit.sqFt
                      ? ReraAreaDisplayUnit.sqMeters
                      : ReraAreaDisplayUnit.sqFt;
                });
              },
              borderRadius: BorderRadius.circular(8),
              child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                onChanged: (val) {
                  setModalState(() {
                    selectedType = ReraRoomData.inferRoomSpaceType(val);
                  });
                },
              ),
              const SizedBox(height: 12),
